...
- improve their mechanicus setup based on actual usage using mechanicus skill;
...
Store session summaries in `~/.config/opencode/mechanicus/reflections/sessions/`.
...
- active mechanicus preset, model routing, skills, and MCP permissions;
